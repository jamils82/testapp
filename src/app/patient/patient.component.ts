...
export class PatientComponent implements OnInit {
  ...
  insertSess() {
   ...
   // return this.http.put('https://doctestapp.herokuapp.com/api/session' , 'saad');
    return this.http.post('https://doctestapp.herokuapp.com/api/postdata', {name : this.callername}).subscribe( data  => {
       this.testname = data;
       console.log(this.testname);
    });
  }
  getSess() {
    return this.http.get('https://doctestapp.herokuapp.com/api/cat/saad', {responseType: 'text'} ).subscribe( data => {
